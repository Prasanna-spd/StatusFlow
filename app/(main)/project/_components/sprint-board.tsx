...
export default function SprintBoard({ sprints, projectId, orgId }) {
  ...
  return (
    <div className="flex flex-col">
      ...
      <IssueCreationDrawer isOpen={isDrawerOpen} onClose={() => setIsDrawerOpen(false)} sprintId={currentSprint.id} status={selectedStatus} projectId={projectId} onIssueCreated={handleIssueCreated} orgId={orgId} />
    </div>
  );
}
